...
def plot4(algo_name, series_name, dfa):
    plt.clf()
    ...
    fn = './output/' + str(uuid.uuid4()) + '_' + series_name + '_' + algo_name + '_iterations4.png'
    plt.savefig(fn)
...
if __name__ == "__main__":
    ...
    plot2(df6.ix[0:100000,:], 'Simulated Annealing (0.95)', 'Four Peaks')
    plot2(df7.ix[0:100000,:], 'Genetic Algorithm (200, 100, 10', 'Four Peaks')
    plot2(df8.ix[0:100000,:], 'MIMIC (200, 20)', 'Four Peaks')
